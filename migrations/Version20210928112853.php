 ...
 */
final class Version20210928112853 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE question ADD cour_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE user ADD entreprise_id INT DEFAULT NULL, ADD nom VARCHAR(255) DEFAULT NULL, ADD prenom VARCHAR(255) DEFAULT NULL, ADD image VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE question DROP cour_id');
        ...
        $this->addSql('ALTER TABLE user DROP entreprise_id, DROP nom, DROP prenom, DROP image');
    }
}
